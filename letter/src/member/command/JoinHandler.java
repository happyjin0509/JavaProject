...
public class JoinHandler implements CommandHandler {
	...
	private static final String FORM_VIEW = "WEB-INF/views/member/joinForm.jsp";
	...
	private String processSubmit(HttpServletRequest req, HttpServletResponse res) {
		...
		/*
		 * String email_id = req.getParameter("email_id"); String email_server =
		 * req.getParameter("email_server"); joinReq.setEmail(email_id +
		 * "@"+email_server);
		 */
