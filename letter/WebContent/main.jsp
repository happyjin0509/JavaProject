...
<header>
        <div class="container">
            <div class="container-small">
                <a href="main.jsp" class="headA">ButterFly</a>
            ...
            <nav class="headB">
                ...
                <c:if test="${authUser == null }">
                   ...
                   <c:if test="${authUser != null }">
                    ...
                    <li><a href="${conPath }/modifyInfo.do">마이페이지</a></li>
                    <li><a href="${conPath }/article/list.do">게시판</a></li>
                </ul>
            </nav>
        </div>
    </header>
<section class="conA">
        <div class="container">
            <img src="${conPath }/images/butterfly.png" alt="">
            <h1>ButterFly</h1>
            <p></p>
            <a href="#">구경하기</a>
        </div>
